    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Description", "Name", "UsuarioId" },
                values: new object[,]
                {
                    { new Guid("a3b7f98d-4e1c-41c2-8e7b-5a6f3d9a8b2c"), "Administrador del sistema", "Admin", null },
                    { new Guid("b8d7a9c3-5e4f-4c2b-9d6a-7f1e3d8c2a4b"), "Gestion de ventas", "Vendedor", null },
                    { new Guid("c9b2d6a3-7f4e-1d8c-5a7b-3e2f4d9c1b8a"), "Usuario", "User", null },
                    { new Guid("d5e1f4a7-8c9b-6b2d-3a7c-5f4e1d2b9a8c"), "Encargado de inventario", "Inventario", null },
                    { new Guid("f4c2e3d1-987a-4b6c-a5f8-d3e2c7b9a1d4"), "Gerencia/Supervisor", "Gerente", null }
                });
